...
class CorpusIndex:
    ...
    def __init__(self, corpus: list[str]):
        ...
        self.vocab, self.tokenize = self.build_vocab(self.preprocessed)
    ...
    def build_vocab(self, preprocessed: list[list[str]]) -> tuple[list, dict]:
        vocab_set = set()
        ...
        tokenize = {word: i for i, word in enumerate(vocab)}
